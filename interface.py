...
# Form implementation generated from reading ui file 'demonstration.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_2.setGeometry(QtCore.QRect(0, 80, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.tab)
        self.label_3.setGeometry(QtCore.QRect(300, 360, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.textEdit = QtWidgets.QTextEdit(self.tab)
        self.textEdit.setGeometry(QtCore.QRect(110, 10, 681, 251))
        self.textEdit.setObjectName("textEdit")
        self.pushButton = QtWidgets.QPushButton(self.tab)
        self.pushButton.setGeometry(QtCore.QRect(330, 280, 191, 51))
        self.pushButton.setObjectName("pushButton")
        self.lineEdit = QtWidgets.QLineEdit(self.tab)
        self.lineEdit.setGeometry(QtCore.QRect(410, 360, 131, 41))
        ...
        # 添加功能函数
        self.pushButton_2.clicked.connect(self.uploadfile)  # 选择excel文件
        self.pushButton_3.clicked.connect(self.choosefile)  # 选择要输出的文件夹路径
        self.tabWidget.setStyleSheet("pane{top:-1px;};")
        self.tabWidget.setStyleSheet("background-image: url(./resources/background1.png);")  # 设置背景图片
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "评论文本"))
        self.label_3.setText(_translate("Form", "情感类别:"))
        self.textEdit.setPlaceholderText(_translate("Form", "请输入要进行情感分类的文本"))
        self.pushButton.setText(_translate("Form", "单条文本情感分类"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Form", "单条文本分类"))
        self.label_4.setText(_translate("Form", "批量导入文本"))
        self.pushButton_2.setText(_translate("Form", "选择Excel文件"))
        self.lineEdit_2.setPlaceholderText(_translate("Form", "Excel文本文件路径"))
        ...
        self.pushButton_4.setText(_translate("Form", "进行批量情感分类"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Form", "批量文本分类"))
...
# 选择excel文件
    ...
    # 消息提示
    def warn1(self):
        QMessageBox().warning(None, "警告", "要进行情感分类的文本内容不能为空！", QMessageBox.Close)
    ...
    def success(self):
        QMessageBox().information(None, "提示", "批量文本分类完成！", QMessageBox.Close)
